...
zbase0 = xr.open_dataset('../../run_data/bedmachine_modified_bedrock_geometry_1km_6144.nc').topg #../data/ase_bedmachine_geometry_500m.2d.nc').topg[::2, ::2] #read in at half resolution
# based on modern inverted
cmin = 7000.
# based on average of modern inverted
cmax = @WeertC #59167.21763599102
